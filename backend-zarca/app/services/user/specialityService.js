...
const entityModel = db.specialities;

const specialityService = {};

specialityService.createEntity = async (data) => {    
    let entity = null;    
    try {
...
specialityService.getAll = async (data) => {
...
specialityService.get = async (id) => {    
    return await entityModel.findOne({ where: { id: id }});
};

specialityService.updateEntity = async (id, data) => {
    delete data.id;    
...
specialityService.deleteEntity = async (id) => {    
    try {
